...
nav.createNav("./assets/imgs/logo.png", './api/logout.php', 'api/checkIfLoggedIn.php', '#','./pages/upload' ,'./pages/login', './pages/allrecipes', './pages/allrecipes/index.html?search', './pages/profile','./uploads/profpic/', './pages/about'  )
